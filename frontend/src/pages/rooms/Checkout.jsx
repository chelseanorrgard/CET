...
const Checkout = () => {
    ...
    const totalPrice = cartItems.reduce((acc, item) => acc + item.price_per_night, 0).toFixed(2);
                                        ...
                                        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                            ...
                                            <div className="md:col-span-2">
                                                ...
                                                <div className="h-10 bg-gray-50 flex border border-gray-200 rounded items-center mt-1">
                                                    ...
                                                    <button tabIndex="-1" className="cursor-pointer outline-none focus:outline-none border-l border-gray-200 transition-all text-gray-300 hover:text-green-600">
                                            ...
                                            <div className="md:col-span-5 mt-3">
                                                <div className="inline-flex items-center">
                                                    ...
                                                    <label htmlFor="billing_same" className="ml-2 ">I agree to the <Link className='underline underline-offset-2 text-green-600'>Terms & Conditions</Link> and <Link className='underline underline-offset-2 text-green-600'>Shoping Policy.</Link></label>
                                                </div>
                                            </div>
                                            ...
                                            <div className="md:col-span-5 text-right">
                                                <div className="inline-flex items-end">
                                                    <button
                                                        disabled={!isChecked}
                                                        className="bg-green-900 hover:bg-green-950 text-white font-bold py-2 px-4 rounded">Place an Order</button>
                                                </div>
                                            </div>

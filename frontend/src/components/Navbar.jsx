...
const Navbar = () => {
  ...
  return (
      ...
      {isDropdownOpen && (
         ...
         <ul className="py-2">
             ...
             <li>
              ...
              className="block w-full px-4 py-2 text-sm hover:bg-gray-100">LogOut</button>
             </li>
         </ul>
     </div>
      )}
    ...
    <Link to="/cart" className="bg-[#8BB68A] p-1 sm:px-6 px-2 flex items-center rounded-sm">

    ...
    <div className="h-[calc(100vh-120px)] flex justify-center items-center">
      <div className="w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
             <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-5 rounded focus:outline-none'>Sign Up</button>
          </div>
        </form>
          ...
          <div className='mt-4'>
                ...
                className='w-full flex flex-wrap gap-1 items-center justify-center bg-indigo-900 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none'>
                Sign in with Google
                </button>
            </div>

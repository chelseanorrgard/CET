...
const Order = require('../orders/order.model.jsx');
const Room = require('../rooms/room.model.jsx');
...
router.get("/", async (req, res) => {
    try {
        ...
        const trendingBooksCount = await Room.aggregate([
        ...
        const totalBooks = await Room.countDocuments();
